...
% \usepackage[rgb, hyperref, dvipsname]{xcolor}  % Coloured text etc.
%custom command mapping to better visualise TODOS
...
Tento dokument popisuje evaluační nástroj, který vynikl jako týmová dlouhodobá maturitní práce. Tento nástroj je realizován formou webové aplikace a zabývá se vzájemným hodnocením studentů a učitelů. Je koncipován pro prostředí střední školy.
}
\CzechKeywords{Evaluační nástroj; Škola; Webová aplikace; Symfony; Import; PHP}
\EnglishAbstract{
}
\EnglishKeywords{}
