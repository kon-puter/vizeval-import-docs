...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Figures/vyuziti_skolnich_systemu.PNG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Figures/nasazeni-bakalaru.png}
