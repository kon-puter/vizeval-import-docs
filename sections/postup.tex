...
Pak se prochází instance entit, které byly přávě naimportovány a pokuď nejsou v \codename{entityMap} tak se uloží pomocí hromadné operace a staré \codename{ImportedEntity} se upraví pomocí metody \codename{updateFromSelf}\footnote{Tato operace nemusí být využita}.


\section{O korcích importu}

Kroky importu jsou nezávislé na zdroji importu. 
Jedná se o import wizzard, kdy konečný automat(FSM) rozhoduje o dalším možném stavu. 
...
K importu bylo využito hodně packagů ze Symfony UX.
Používám Symfony Form na formulář pro zadání souborů a genrování emailu.
